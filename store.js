...
// mesmo que  a página não esteja carregando, vai fazer operações
function ready(){
...
function quantityChange(event){
    ...
    // quantidade do produto, não pode ser negativa ou string
...
function updateCartTotal() {
    ...
    for (var i = 0; i < cartRows.length; i ++){
        ...
        // pega o preço que ta em texto la e tira o dólar
